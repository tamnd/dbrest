...
// Write renders e onto w: it sets the JSON content type, the WWW-Authenticate
// challenge when one is carried, and the status, then writes the envelope. It
// is the single place an error reaches the client.
